INSERT INTO `Sentence` (`http_code`, `tag`, `message`) VALUES 
(   701,  "Inexcusable", " Meh"),
...
(   706,  "Inexcusable", " Delete Your Account"), (   707,  "Inexcusable", " Can't quit vi"),
(   710,  "Novelty Implementations", " PHP"),
(   711,  "Novelty Implementations", " Convenience Store"), (   712,  "Novelty Implementations", " NoSQL"), (   718,  "Novelty Implementations", " I am not a teapot"), (   719,  "Novelty Implementations", " Haskell"), (   720,  "Edge Cases", " Unpossible"),
(   721,  "Edge Cases", " Known Unknowns"),
(   722,  "Edge Cases", " Unknown Unknowns"),
(   723,  "Edge Cases", " Tricky"),
(   724,  "Edge Cases", " This line should be unreachable"), (   725,  "Edge Cases", " It works on my machine"), (   726,  "Edge Cases", " It's a feature, not a bug"), (   727,  "Edge Cases", " 32 bits is plenty"),
(   728,  "Edge Cases", " It works in my timezone"),
(   730,  "Fucking", " Fucking npm"), (   731,  "Fucking", " Fucking Rubygems"),
...
(   759,  "Syntax Errors", " Unexpected `T_PAAMAYIM_NEKUDOTAYIM`"), (   761,  "Substance", " Hungover"),
...
(   779,  "Predictable Problems", " Off By Too Many To Count Error"), (   780,  "Somebody Else's Problem", " Project owner not responding"), (   781,  "Somebody Else's Problem", " Operations"),
(   782,  "Somebody Else's Problem", " QA"),
(   783,  "Somebody Else's Problem", " It was a customer request, honestly"), (   784,  "Somebody Else's Problem", " Management, obviously"),
(   785,  "Somebody Else's Problem", " TPS Cover Sheet not attached"), (   786,  "Somebody Else's Problem", " Try it now"),
(   787,  "Somebody Else's Problem", " Further Funding Required"), (   788,  "Somebody Else's Problem", " Designer's final designs weren't"), (   789,  "Somebody Else's Problem", " Not my department"),
